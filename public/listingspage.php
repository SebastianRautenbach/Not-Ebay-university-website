  ...
  <div class="container my-2 p-2">
    <nav aria-label="navigation">
      <ul class="pagination justify-content-center">
        <li class="page-item"><a class="page-link" href="?q=listings&category=<?php echo $search_query; ?>&page=<?php if ($current_page >= 0) {
                                                                                                                  echo 1;
                                                                                                                } else {
                                                                                                                  echo $current_page - 1;
                                                                                                                }; ?>">Previous</a></li>
        ...
        <?php endfor; ?>
        <li class="page-item"><a class="page-link" href="?q=listings&category=<?php echo $search_query; ?>&page=<?php if ($current_page >= $total_pages) {
                                                                                                                  echo $current_page;
                                                                                                                } else {
                                                                                                                  echo $current_page + 1;
                                                                                                                }; ?>">Next</a></li>
